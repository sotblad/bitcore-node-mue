...
describe('Bitcoin Service', function() {
  ...
  describe('#_wrapRPCError', function() {
    it('will convert bitcoind-rpc-mue error object into JavaScript error', function() {
      var bitcoind = new BitcoinService(baseConfig);
  ...
  describe('#govObject', function() {
    it('will call client gobject list and give result', function(done) {
        ...
        var gobject = sinon.stub().callsArgWith(1, null, {
            result: [{
                ...
                "DataHex": "",
                "DataObject": {
                ...
                "DataHex": "",
                "DataObject": {
                ...
                "DataHex": "",
                "DataObject": {
    ...
    it('will call client gobject get and give result', function(done) {
      ...
      var gobject = sinon.stub().callsArgWith(2, null, {
        result: {
          "DataHex": "",
          "DataString": "[[\"proposal\",{\"end_epoch\":1483855193,\"name\":\"7ea9acff5ae83d8c9e217d30a2b4d10ef8f171f8\",\"payment_address\":\"yZ7DYkDHCHfH1dw7rKdYaKcVykZmunbqNL\",\"payment_amount\":84,\"start_epoch\":1483765282,\"type\":1,\"url\":\"https://www.monetaryunit.org\"}]]",
          "Hash": "4ef24027c631c43035aa4cf5c672e1298311decd9cffbd16731f454c9c0d6d00",
      ...
      bitcoind.govObjectHash('4ef24027c631c43035aa4cf5c672e1298311decd9cffbd16731f454c9c0d6d00', function(err, result) {
        ...
        should.equal(DataObject.url, 'https://www.monetaryunit.org');
        done();
      });
    });
  	...
  	describe('#sporksList', function(){
		it('will call client sporks and give result', function(done){
					...
					spork: function(param, callback){
						if(param==="show"){
							callback(null,{result:{
								"SPORK_1_INSTANTSEND_ENABLED":0,
								"SPORK_2_INSTANTSEND_BLOCK_FILTERING":0,
								"SPORK_3_INSTANTSEND_MAX_VALUE":20000,
								"SPORK_4_MASTERNODE_PAYMENT_ENFORCEMENT":0,
								"SPORK_5_SUPERBLOCKS_ENABLED":0,
			...
			bitcoind.getSpork(function(err, SporkList) {
				...
				sporks['SPORK_4_MASTERNODE_PAYMENT_ENFORCEMENT'].should.equal(0);
				sporks['SPORK_5_SUPERBLOCKS_ENABLED'].should.equal(0);
				sporks['SPORK_6_RECONSIDER_BLOCKS'].should.equal(0);
				sporks['SPORK_7_REQUIRE_SENTINEL_FLAG'].should.equal(4070908800);
				done();
			});
		});
	});
        ...
        client: {
          masternodelist: function(type, cb){
            switch (type){
              ...
              case "addr":
                return cb(null, { result:
                  { '06c4c53b64019a021e8597c19e40807038cab4cd422ca9241db82aa19887354b-0': "108.61.209.47:13333",
                    'b76bafae974b80204e79858eb62aedec41159519c90d23f811cca1eca40f2e4c-1': "34.226.228.73:13333"}
                });
              case "status":
                return cb(null, { result:
                  { '06c4c53b64019a021e8597c19e40807038cab4cd422ca9241db82aa19887354b-0': "ENABLED",
