...
describe('#defaultConfig', function() {
  var expectedExecPath = path.resolve(__dirname, process.env.HOME, './.bitcore/data/terracoind');
    ...
    var defaultConfig = proxyquire('../../lib/scaffold/default-config', {
      fs: {
        ...
        writeFileSync: function(path, data) {
          path.should.equal(process.env.HOME + '/.bitcore/bitcore-node-terracoin.json');
