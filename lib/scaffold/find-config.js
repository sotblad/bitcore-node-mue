...
/**
 * Will return the path and bitcore-node-terracoin configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'bitcore-node-terracoin.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'bitcore-node-terracoin.json'))
  };
}
