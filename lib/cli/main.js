...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --daemon', 'Make bitcore-node-terracoin a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitcore-node-terracoin create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitcore-node-terracoin add wallet-service');
      console.log('    $ bitcore-node-terracoin add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitcore-node-terracoin remove wallet-service');
      console.log('    $ bitcore-node-terracoin remove insight-api');
      console.log();
    });
