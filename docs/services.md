...
```json
{
  "dependencies": {
    ...
    "insight-api-mue": "muecoin/insight-api-mue"
  }
}
```
...
The `package.json` for the service module can either export the `Node.Service` directly, or specify a specific module to load by including `"bitcoreNode": "lib/bitcore-node-mue.js"`.
